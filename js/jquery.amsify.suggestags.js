    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        AmsifySuggestags.prototype = {
            ...
            createHTML : function() {
                ...
                this.inputDisabled            = (settings.disabled === true) ? 'disabled' : '';
                var sTagsInput                = '<input type="text" class="'+this.classes.sTagsInput.substring(1)+'" placeholder="'+this.defaultLabel+'"'+this.inputDisabled+ '>';
